...
var file_service_stocks_proto_rawDesc = []byte{
	...
	0x32, 0xf2, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x73, 0x12, 0x37, 0x0a, 0x08, 0x47,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x3d, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73,
...
var file_service_stocks_proto_goTypes = []interface{}{
	...
	(*GetQuoteResponse)(nil),   // 4: pb.GetQuoteResponse
...
var file_service_stocks_proto_depIdxs = []int32{
	...
	4, // 4: pb.Stocks.GetQuote:output_type -> pb.GetQuoteResponse
	5, // 5: pb.Stocks.CreateUser:output_type -> pb.CreateUserResponse
	6, // 6: pb.Stocks.GetUser:output_type -> pb.GetUserResponse
	7, // 7: pb.Stocks.LoginUser:output_type -> pb.LoginUserResponse
